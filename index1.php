		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<h1><font color="red">ClubCraft<h2>GALLERY</h2></font></h1>
             ...
             ?>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						 <a href="#"><img class="img-responsive" height="100%" src="images1/hockey.jpg" alt=""></a> 
						<h1></h1>
						<h1></h1>
						<div class="blog-text">
							<h1></h1>
                    ...
                    <tr>
                        <td><h4 align="left">Entry Fees :</h4></td>
                        <td><span><?=$row['entry_fees']?></span></td>
                    </tr>
                    <tr>
                        <td><h4 align="left">Win Price :</h4></td>
	...
	<div id="fh5co-started" class="fh5co-bg" style="background-image: url(images1/img-03_002.jpg);">
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
					<h2>Sports Classes <br><span>Play Now </span></h2>
				</div>
			</div>
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
