                      ...
                      <table width="40%" height="500px">
						<div class="row form-group">
							...
							<div class="col-md-12">
								...
								<td><input type="text" id="mobile" name="p_design"class="form-control" required></td>
							</tr>
							</div>
						</div>
                        <div class="row form-group">
						...
						<div class="row form-group">
							<div class="col-md-12">
								<tr>
								<td>Player Tye</td>
								<td><select class="form-control" required name="ptype" required>
						...
						<div class="row form-group">
                         ...
                         <div class="row form-group">
							<div class="col-md-12">
								<tr>
								<td>Player Image:</td>
								<td><input type="file" id="gametype" name="image" required></td>
							</tr>
							</div>
						</div>
