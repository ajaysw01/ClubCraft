...
<body>
	...
	<div id="page">
					...
					<div class="row">
						<div class="col-xs-12 text-right">
							...
							<ul class="fh5co-social">
								...
								<li><a href="http://localhost/php/sport/code/admin/admin_login.html"><i
		...
		<header id="fh5co-header" class="fh5co-cover animate" role="banner" style=""
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
						<h1>
							<font color="red">ClubCraft<h2>GALLERY</h2>
							</font>
						</h1>
					...
					<div class="col-md-12">
						<ul id="fh5co-portfolio-list">
							...
							<li class="one-third animate-box" data-animate-effect="fadeIn"
								style="background-image: url(images1/post2.png); ">
								<a href="#">
							...
							<li class="one-third animate-box" data-animate-effect="fadeIn"
								style="background-image: url(images1/match-start-img.png); ">
								<a href="#">
									<div class="case-studies-summary">
										<span>ClubCraft</span>
							...
							<li class="one-third animate-box" data-animate-effect="fadeIn"
								style="background-image: url(images1/bg4.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
										<span>ClubCraft</span>
										<h2>Useful Basket</h2>
							...
							<li class="one-third animate-box" data-animate-effect="fadeIn"
								style="background-image: url(images1/img-07.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
										<span>ClubCraft</span>
							...
							<li class="one-third animate-box" data-animate-effect="fadeIn"
								style="background-image: url(images1/img-05.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
										<span>ClubCraft</span>
										<h2>Cricket</h2>
							...
							<li class="two-third animate-box" data-animate-effect="fadeIn"
								style="background-image: url(images1/img-04.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
										<span>ClubCraft</span>
										<h2>Hockey</h2>
							...
							<li class="one-third animate-box" data-animate-effect="fadeIn"
								style="background-image: url(images1/main-slider-img1.jpg); ">
								<a href="#">
									<div class="case-studies-summary">
										<span>ClubCraft</span>
										<h2>Badmintan</h2>
		...
		<div id="fh5co-services" class="fh5co-bg-section" style="height: 40px; padding: 4em;">
			<H1 align="center">
				<font color="black"><span id="font"><u>UPCOMING TOURNAMENTS</u></span></font>
			</H1>
					...
					while ($row = mysqli_fetch_array($query)) {
						...
						<div class="col-lg-4 col-md-4">
							<div class="fh5co-blog animate-box">
								<a href="#"><img class="img-responsive" height="100%" src="images1/img-03_003.jpg"
										alt=""></a>
								<h1></h1>
								<h1></h1>
								<div class="blog-text">
									...
									<table width="100%">
										...
										<tr>
											<td>
												<h4 align="left">Player Participate :</h4>
											</td>
											<td><span>
													<?= $row['player_size'] ?>
												</span></td>
	...
	<div id="fh5co-started" class="fh5co-bg" style="background-image: url(images1/img-03_002.jpg);">
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
					<h2>Sports Classes<br><span>Coming soon... </span></h2>
				</div>
			</div>
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
	...
	<div id="fh5co-services" class="fh5co-bg-section" style="height: 40px; padding: 4em;">
		<H1 align="center">
			<font color="black"><span id="font"><u>UPCOMING EVENTS!</u></span></font>
		</H1>
						...
						<div class="fh5co-blog animate-box">
							...
							<div class="blog-text" style="margin-top:-2em;">
								...
								<h1 align="left"><a href="">
										<?= $row['groupA_team_name'] ?>
									</a></h1>
								<h2 align="center"><a href="">VS</a></h2>
								<h1 align="right"><a href="">
										<?= $row['groupB_team_name'] ?>
									</a></h1>
								<span class="posted_on">Welcome To ClubCraft</span>
								<hr>
								<center>
