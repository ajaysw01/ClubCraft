...
<div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/Dark.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            <h2 class="text-white font-weight-light text-uppercase font-weight-bold">ADD SCHEDULE</h2>
           <!--  <p class="breadcrumb-custom"> -->
            
         <div class="box">
    <form method="post" action="./php/insert_schedule.php">
   ...
   <tr>
       ...
       <th colspan="2"><input type="text" id="tf" name="team_a" required></th>
   </tr>
   <tr>
     <th colspan="2" align="left">Second Team :</th>
     <th colspan="2"><input type="text" id="tf" name="team_b" required></th>
 </tr>
 <tr>
       <th colspan="2" align="left">Match Date :</th>
       <th colspan="2"><input type="date" id="tf" name="m_date" required></th>
     </tr>
      <tr>
       <th colspan="2" align="left"> Match Time :</th>
       <th colspan="2"><input type="text" id="tf" name="m_time" required></th>
     </tr>
   <tr>
 ...
 <table class="tbl2">
    <tr>
       <th colspan="4" align="center"><input type="submit" id="btn" value="ADD" name="schedule"></th>
